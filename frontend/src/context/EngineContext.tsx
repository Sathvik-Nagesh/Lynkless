...
export const EngineProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  // Bolt: Use lazy state initialization to guarantee that managers are only instantiated once.
  // This is safe under React Concurrent Mode and avoids accessing a ref during render.
