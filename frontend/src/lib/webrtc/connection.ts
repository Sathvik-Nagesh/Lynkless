...
export class WebRTCManager {
  ...
  async sendToPeer(
    ...
    // Bolt: Optimized data channel selection to eliminate per-chunk array allocations
    ...
    // Fallback to legacy single-channel reference if no parallel channels are open
