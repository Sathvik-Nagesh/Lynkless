...
export class WebRTCManager {
  ...
  async sendToPeer(
    ...
    // Bolt: Zero-allocation data channel selection.
    // Replaces .filter() and .reduce() with a manual loop to find the open channel with
    // the least buffered data. This eliminates per-chunk array allocations on high-throughput paths.
