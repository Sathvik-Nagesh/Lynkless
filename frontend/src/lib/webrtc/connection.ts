...
export class WebRTCManager {
  ...
  async sendToPeer(
    ...
    // Bolt: Optimized data channel selection via manual for-loop (avoiding .filter and .reduce allocations)
    // Measurement: Eliminates ~2 array allocations and 2 full passes per 64KB chunk.
    ...
    // Fallback to legacy single channel if no parallel channels are open
