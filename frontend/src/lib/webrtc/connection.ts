...
export class WebRTCManager {
  ...
  async sendToPeer(
    ...
    // Bolt: Optimized data channel selection using a manual for-loop.
    // This avoids per-chunk array allocations (filter/reduce) in the high-frequency transmission path.
    ...
    // Fallback to legacy single dataChannel if no parallel channels are open
