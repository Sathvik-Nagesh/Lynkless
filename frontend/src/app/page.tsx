...
export default function Home() {
  ...
  // Derived state eliminates cascading render cycles on transfer updates
  ...
  // Handle file drop - queue files (modal will be shown via derived state)
  ...
  // Derived state eliminates cascading render cycles when files are queued / peers connect
