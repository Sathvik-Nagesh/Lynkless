...
export default function Home() {
  ...
  // Derived state to eliminate synchronous setState in useEffect and cascading re-renders
  ...
  const handleConfirmSend = useCallback(async (password?: string, shouldZip?: boolean, compressImagesFlag?: boolean) => {
    // Clear pending files immediately so modal closes automatically via derived state
  ...
  // Derive showFilePreview purely from pendingFiles and connectedPeers
